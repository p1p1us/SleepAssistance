...
import com.devdroid.sleepassistant.view.SelectRemindCyclePopup;
import com.devdroid.sleepassistant.view.SelectRemindWayPopup;
import com.loonggg.lib.alarmmanager.clock.AlarmManagerUtil;

import java.text.SimpleDateFormat;
import java.util.Date;

public class SleepWarnActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sleep_warn);
            ...
            if (cycle == 0) {//是每天的闹钟
                ...
                for (int i = 0; i < weeks.length; i++) {
                    AlarmManagerUtil.setAlarm(this, 2, Integer.parseInt(times[0]), Integer
                            .parseInt(times[1]), i, Integer.parseInt(weeks[i]), "该睡觉啦", ring);
                }
            }
            Toast.makeText(this, "睡眠提醒设置成功", Toast.LENGTH_LONG).show();
        }
