...
import com.devdroid.sleepassistant.activity.ListViewMultiChartActivity;
import com.devdroid.sleepassistant.activity.MainActivity;
import com.devdroid.sleepassistant.activity.MyEquipsActivity;
import com.devdroid.sleepassistant.activity.RankingListActivity;
...
import com.devdroid.sleepassistant.activity.SleepSupportActivity;
...
public class NavigationItemSelectedListener  implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.nav_trend :
                mAppCompatActivity.startActivity(new Intent(mAppCompatActivity, ListViewMultiChartActivity.class));
                break;
            case R.id.nav_helper:
                mAppCompatActivity.startActivity(new Intent(mAppCompatActivity, SleepSupportActivity.class));
                break;
            ...
            case R.id.nav_about :
                ...
                break;
            case R.id.nav_sort :
                mAppCompatActivity.startActivity(new Intent(mAppCompatActivity, RankingListActivity.class));
                break;
            case R.id.nav_mySets :
                mAppCompatActivity.startActivity(new Intent(mAppCompatActivity, MyEquipsActivity.class));
                break;
        }
