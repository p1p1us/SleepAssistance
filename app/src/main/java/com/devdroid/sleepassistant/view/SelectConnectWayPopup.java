...
public class SelectConnectWayPopup implements OnClickListener {
    ...
    public SelectConnectWayPopup(Context context) {
        mContext = context;
    ...
    public View initViews() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.selectconnectway_pop_window,
                null);
